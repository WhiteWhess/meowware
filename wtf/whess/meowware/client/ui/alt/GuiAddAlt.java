...
public class GuiAddAlt extends GuiScreen {
   ...
   public GuiAddAlt(GuiAltManager manager) {
      this.status = ChatFormatting.GRAY + "Idle...";
   ...
   private class AddAltThread extends Thread {
      ...
      public AddAltThread(String username, String password) {
         ...
         GuiAddAlt.access$0(GuiAddAlt.this, ChatFormatting.GRAY + "Idle...");
      }
      ...
      private final void checkAndAddAlt(String username, String password) throws IOException {
         ...
         try {
            ...
            GuiAddAlt.access$0(GuiAddAlt.this, ChatFormatting.RED + "Alt failed!");
      ...
      public void run() {
         if (this.password.equals("")) {
            ...
            GuiAddAlt.access$0(GuiAddAlt.this, ChatFormatting.GREEN + "Alt added. (" + this.username + " - offline name)");
         } else {
            GuiAddAlt.access$0(GuiAddAlt.this, ChatFormatting.YELLOW + "Trying alt...");

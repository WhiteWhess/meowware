...
public class Minecraft implements IThreadListener, ISnooperInfo
{
    ...
    private static final ResourceLocation LOCATION_MOJANG_PNG = new ResourceLocation("meowware/launch.png");
    ...
    private final Snooper usageSnooper = new Snooper("main", this, MinecraftServer.getCurrentTimeMillis());
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle("Loading " + MeowWare.NAME + " " + MeowWare.STATUS + " " + MeowWare.VERSION);
    ...
    private void setWindowIcon()
    {
        ...
        if (util$enumos != Util.EnumOS.OSX)
        {
            ...
            try
            {
                ...
                //MEOWWARE HOOK
                inputstream = ClassLoader.getSystemClassLoader().getResourceAsStream("32x32.png");
                inputstream1 = ClassLoader.getSystemClassLoader().getResourceAsStream("64x64.png");
    ...
    public void displayCrashReport(CrashReport crashReportIn)
    {
        ...
        File file2 = new File(file1, "crash-" + (new SimpleDateFormat("yyyy-MM-dd_HH.mm.ss")).format(new Date()) + "-main.txt");
    ...
    public CrashReport addGraphicsAndWorldToCrashReport(CrashReport theCrash)
    {
        ...
        theCrash.getCategory().setDetail("Is Modded", new ICrashReportDetail<String>()
        {
            public String call() throws Exception
            {
                ...
                {
                    return Minecraft.class.getSigners() == null ? "Very likely; Jar signature invalidated" : "Probably not. Jar signature remains and main brand is untouched.";
                }
            }
        });

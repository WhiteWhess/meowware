...
public class Reflector
{
    ...
    public static ReflectorClass Attributes = new ReflectorClass("net.minecraftforge.main.model.Attributes");
    public static ReflectorField Attributes_DEFAULT_BAKED_FORMAT = new ReflectorField(Attributes, "DEFAULT_BAKED_FORMAT");
    public static ReflectorClass BetterFoliageClient = new ReflectorClass("mods.betterfoliage.main.BetterFoliageClient");
    ...
    public static ReflectorClass DrawScreenEvent_Pre = new ReflectorClass("net.minecraftforge.main.event.GuiScreenEvent$DrawScreenEvent$Pre");
    ...
    public static ReflectorClass DrawScreenEvent_Post = new ReflectorClass("net.minecraftforge.main.event.GuiScreenEvent$DrawScreenEvent$Post");
    ...
    public static ReflectorClass EntityViewRenderEvent_CameraSetup = new ReflectorClass("net.minecraftforge.main.event.EntityViewRenderEvent$CameraSetup");
    ...
    public static ReflectorClass EntityViewRenderEvent_FogColors = new ReflectorClass("net.minecraftforge.main.event.EntityViewRenderEvent$FogColors");
    ...
    public static ReflectorClass EntityViewRenderEvent_RenderFogEvent = new ReflectorClass("net.minecraftforge.main.event.EntityViewRenderEvent$RenderFogEvent");
    ...
    public static ReflectorClass FMLClientHandler = new ReflectorClass("net.minecraftforge.fml.main.FMLClientHandler");
    ...
    public static ReflectorClass ForgeHooksClient = new ReflectorClass("net.minecraftforge.main.ForgeHooksClient");
    ...
    public static ReflectorClass GuiModList = new ReflectorClass("net.minecraftforge.fml.main.GuiModList");
    ...
    public static ReflectorClass IModel = new ReflectorClass("net.minecraftforge.main.model.IModel");
    public static ReflectorMethod IModel_getTextures = new ReflectorMethod(IModel, "getTextures");
    public static ReflectorClass IRenderHandler = new ReflectorClass("net.minecraftforge.main.IRenderHandler");
    public static ReflectorMethod IRenderHandler_render = new ReflectorMethod(IRenderHandler, "render");
    public static ReflectorClass ItemModelMesherForge = new ReflectorClass("net.minecraftforge.main.ItemModelMesherForge");
    ...
    public static ReflectorClass KeyConflictContext = new ReflectorClass("net.minecraftforge.main.settings.KeyConflictContext");
    public static ReflectorField KeyConflictContext_IN_GAME = new ReflectorField(KeyConflictContext, "IN_GAME");
    public static ReflectorClass KeyModifier = new ReflectorClass("net.minecraftforge.main.settings.KeyModifier");
    ...
    public static ReflectorClass LightUtil = new ReflectorClass("net.minecraftforge.main.model.pipeline.LightUtil");
    ...
    public static ReflectorClass MinecraftForgeClient = new ReflectorClass("net.minecraftforge.main.MinecraftForgeClient");
    ...
    public static ReflectorClass ModelLoader = new ReflectorClass("net.minecraftforge.main.model.ModelLoader");
    ...
    public static ReflectorClass ModelLoader_VanillaLoader = new ReflectorClass("net.minecraftforge.main.model.ModelLoader$VanillaLoader", true);
    ...
    public static ReflectorClass ModelLoaderRegistry = new ReflectorClass("net.minecraftforge.main.model.ModelLoaderRegistry", true);
    public static ReflectorField ModelLoaderRegistry_textures = new ReflectorField(ModelLoaderRegistry, "textures", true);
    public static ReflectorClass NotificationModUpdateScreen = new ReflectorClass("net.minecraftforge.main.gui.NotificationModUpdateScreen");
    public static ReflectorMethod NotificationModUpdateScreen_init = new ReflectorMethod(NotificationModUpdateScreen, "init");
    public static ReflectorClass RenderBlockOverlayEvent_OverlayType = new ReflectorClass("net.minecraftforge.main.event.RenderBlockOverlayEvent$OverlayType");
    ...
    public static ReflectorClass RenderingRegistry = new ReflectorClass("net.minecraftforge.fml.main.registry.RenderingRegistry");
    ...
    public static ReflectorClass RenderItemInFrameEvent = new ReflectorClass("net.minecraftforge.main.event.RenderItemInFrameEvent");
    ...
    public static ReflectorClass RenderLivingEvent_Pre = new ReflectorClass("net.minecraftforge.main.event.RenderLivingEvent$Pre");
    ...
    public static ReflectorClass RenderLivingEvent_Post = new ReflectorClass("net.minecraftforge.main.event.RenderLivingEvent$Post");
    ...
    public static ReflectorClass RenderLivingEvent_Specials_Pre = new ReflectorClass("net.minecraftforge.main.event.RenderLivingEvent$Specials$Pre");
    ...
    public static ReflectorClass RenderLivingEvent_Specials_Post = new ReflectorClass("net.minecraftforge.main.event.RenderLivingEvent$Specials$Post");
    ...
    public static ReflectorClass ScreenshotEvent = new ReflectorClass("net.minecraftforge.main.event.ScreenshotEvent");
    ...
    public static ReflectorClass SplashScreen = new ReflectorClass("net.minecraftforge.fml.main.SplashProgress");

...
import wtf.whess.meowware.client.main.functions.impl.combat.KeepSprint;
    ...
    public void attackTargetEntityWithCurrentItem(Entity targetEntity)
    {
        if (targetEntity.canBeAttackedWithItem())
        {
            if (!targetEntity.hitByEntity(this))
            {
                ...
                //MEOWWARE HOOK
                AttackEntityEvent attackEvent = new AttackEntityEvent(targetEntity);
                attackEvent.call();
                ...
                if (f > 0.0F || f1 > 0.0F)
                {
                    ...
                    if (flag5)
                    {
                        if (i > 0)
                        {
                            ...
                            this.motionX *= 0.6D;
                            this.motionZ *= 0.6D;
                            if (!MeowWare.getInstance().getFunctionManager().getFunctionClass(KeepSprint.class).isToggled())

...
public abstract class GuiSlot
{
    ...
    public void drawScreen(int mouseXIn, int mouseYIn, float partialTicks)
    {
        if (this.visible)
        {
            ...
            RenderUtil.drawRect(0, this.top, width, 0, new Color(20, 20, 20).getRGB());
            RenderUtil.drawRect(0, this.bottom, width, this.height, new Color(20, 20, 20).getRGB());

...
import wtf.whess.meowware.client.ui.monitoring.IGuiMultiplayer;
...
public class ServerSelectionList extends GuiListExtended
{
    ...
    public ServerSelectionList(IGuiMultiplayer ownerIn, Minecraft mcIn, int widthIn, int heightIn, int topIn, int bottomIn, int slotHeightIn)
    {
    ...
    public void updateOnlineShkoloServers(final ServerList p_148195_1_) {
        this.serverListInternet.clear();
        for (int i = 0; i < p_148195_1_.countShkoloServers(); ++i) {
            this.serverListInternet.add(new ServerListEntryNormal(this.owner, p_148195_1_.getShkoloServerData(i)));
        }
    }

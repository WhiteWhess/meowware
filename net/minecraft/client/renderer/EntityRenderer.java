...
import wtf.whess.meowware.client.main.functions.impl.visual.CameraClip;
import wtf.whess.meowware.client.main.functions.impl.visual.FogColor;
import wtf.whess.meowware.client.main.functions.impl.visual.NoRender;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    {
        if (MeowWare.getInstance().getFunctionManager().getFunctionClass(NoRender.class).isToggled() && NoRender.NO_RENDER_HURT_CAM.isToggled())
            return;
        ...
        else if (this.mc.gameSettings.thirdPersonView > 0)
        {
            ...
            else
            {
                ...
                for (int i = 0; i < 8; ++i)
                {
                    ...
                    if (!MeowWare.getInstance().getFunctionManager().getFunctionClass(CameraClip.class).isToggled() && raytraceresult != null)
                    {
    ...
    public void setupCameraTransform(float partialTicks, int pass)
    {
        ...
        if (MeowWare.getInstance().getFunctionManager().getFunctionClass(FogColor.class).isToggled())
            this.farPlaneDistance = (float) (4F * FogColor.DISTANCE.getValue());
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano)
    {
        ...
        new RenderWorldEvent(partialTicks).call();

...
{
    /**
     * entity ID of the player associated with this partially destroyed Block. Used to identify the Blocks in the main
    ...
    /**
     * damage ranges from 1 to 10. -1 causes the main to delete the partial block renderer.
     */
    ...
    /**
     * inserts damage value into this partially destroyed Block. -1 causes main renderer to delete it, otherwise
     * ranges from 1 to 10
     */

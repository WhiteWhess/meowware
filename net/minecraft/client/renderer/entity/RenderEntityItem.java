...
import wtf.whess.meowware.client.main.functions.impl.visual.NoItems;
...
public class RenderEntityItem extends Render<EntityItem>
{
    ...
    {
        if (MeowWare.getInstance().getFunctionManager().getFunctionClass(NoItems.class).isToggled()) {

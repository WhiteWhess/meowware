...
public class ItemRenderer
{
    ...
    {
        //MEOWWARE EVENT
        new TransformSideFirstPersonEvent(p_187456_3_).call();
    ...
    {
        //MEOWWARE HOOK
        new TransformSideFirstPersonEvent(p_187454_2_).call();
    ...
    {
        new TransformSideFirstPersonEvent(p_187459_1_).call();
    ...
    {
        if (MeowWare.getInstance().getFunctionManager().getFunctionClass(NoRender.class).isToggled() && NoRender.NO_RENDER_FIRE.isToggled())
            return;
        Tessellator tessellator = Tessellator.getInstance();
        BufferBuilder bufferbuilder = tessellator.getBuffer();

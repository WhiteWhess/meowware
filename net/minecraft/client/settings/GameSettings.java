...
public class GameSettings
{
    ...
    public KeyBinding keyBindScreenshot = new KeyBinding("key.screenshot", 60, "key.categories.visual");
    public KeyBinding keyBindTogglePerspective = new KeyBinding("key.togglePerspective", 63, "key.categories.visual");
    public KeyBinding keyBindSmoothCamera = new KeyBinding("key.smoothCamera", 0, "key.categories.visual");
    public KeyBinding keyBindFullscreen = new KeyBinding("key.fullscreen", 87, "key.categories.visual");
    public KeyBinding keyBindSpectatorOutlines = new KeyBinding("key.spectatorOutlines", 0, "key.categories.visual");
    public KeyBinding field_194146_ao = new KeyBinding("key.advancements", 38, "key.categories.visual");
    ...
    public GameSettings(Minecraft mcIn, File optionsFileIn)
    {
        ...
        this.ofKeyBindZoom = new KeyBinding("of.key.zoom", 46, "key.categories.visual");
    ...
    /**
     * Send a main info packet with settings information to the server
     */
    ...
    /**
     * Return true if the main connect to a server using the native transport system
     */

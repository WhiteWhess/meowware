...
import wtf.whess.meowware.client.main.functions.impl.misc.NoPush;
import wtf.whess.meowware.client.main.functions.impl.move.NoSlowDown;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    {
        //MEOWWARE HOOK
        PlayerChatEvent chatEvent = new PlayerChatEvent(message);
        chatEvent.call();
        if (chatEvent.isCancelled())
            return;
        message = chatEvent.getText();
    ...
    {
        if (MeowWare.getInstance().getFunctionManager().getFunctionClass(NoPush.class).isToggled())
            return false;
    ...
    public void onLivingUpdate()
    {
        ...
        if (!Objects.requireNonNull(MeowWare.getInstance().getFunctionManager().getFunctionClass(NoSlowDown.class)).isToggled()) {
    ...
    public void moveEntity(MoverType type, double x, double y, double z)
    {
        ...
        super.moveEntity(type, moveEvent.getX(), moveEvent.getY(), moveEvent.getZ());

...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
     ...
     * positioning and handleJoinGame to inform the server of the main distribution/mods)
     */
    ...
    /**
     * True if the main has finished downloading terrain and may spawn. Set upon receipt of S08PacketPlayerPosLook,
    ...
    /**
     * Verifies that the server and main are synchronized with respect to the inventory/container opened by the player
     ...
     * resourcepack for the main to load.
     */
    ...
    /**
     * Gets the main's description information about another player on the server.
     */

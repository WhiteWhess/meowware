...
public interface INetHandlerPlayServer extends INetHandler
{
    ...
    /**
     * Retrieves possible tab completions for the requested command string and sends them to the main
     */
    void processTabComplete(CPacketTabComplete packetIn);

    /**
     * Processes the main status updates: respawn attempt from player, opening statistics or achievements, or
     * acquiring 'open inventory' achievement
     */
    void processClientStatus(CPacketClientStatus packetIn);

    /**
     * Updates serverside copy of main settings: language, render distance, chat visibility, chat colours, difficulty,
     * and whether to show the cape
     */
    void processClientSettings(CPacketClientSettings packetIn);

    /**
     * Received in response to the server requesting to confirm that the main-side open container matches the servers'
    ...
    /**
     * Processes the main closing windows (container)
     */

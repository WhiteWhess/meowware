...
public enum TextFormatting
{
    ...
    /**
     * Matches formatting codes that indicate that the main should treat the following text as bold, recolored,
     * obfuscated, etc.
     */
    ...
    /**
     * The control string (section sign + formatting code) that can be inserted into main-side text to display

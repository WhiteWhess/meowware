...
public abstract class World implements IBlockAccess
{
    ...
    /**
     * True if the world is a 'slave' main; changes will not be saved or propagated from this world. For example,
     * server worlds have this set to false, main worlds have this set to true.
     */
     ...
     * clients (you almost always want this). Flag 4 prevents the block from being re-rendered, if this is a main
    ...
    /**
     * Convenience method to update the block on both the main and server
     */
    ...
    {
        throw new UnsupportedOperationException("Can't send packets to server unless you're on the main.");
    }

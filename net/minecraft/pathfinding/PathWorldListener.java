...
public class PathWorldListener implements IWorldEventListener
{
    ...
    /**
     * On the main, re-renders all blocks in this range, inclusive. On the server, does nothing.
     */
    ...
    /**
     * Called on all IWorldAccesses when an entity is created or loaded. On main worlds, starts downloading any
    ...
    /**
     * Called on all IWorldAccesses when an entity is unloaded or destroyed. On main worlds, releases any downloaded
